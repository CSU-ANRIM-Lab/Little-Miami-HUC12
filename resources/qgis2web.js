...
map.getView().fit([661212.358503, 86774.091061, 1527163.106741, 667594.714880], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Great Miami and Little Miami Watersheds -- ACPF Modeling</h2>';
        return titleElement;
    })(),
